...
//#define TestVideo "../Data/TestVideo/out9.15_4.avi"	//用于检测的测试视频
//#define ResultVideo "../Data/Result/out9.15_4.avi"		//测试视频的检测结果
...
//
//	//变量定义
//	Mat src32FC3,threshold_img,edges;//定义帧：转换数据类型，灰度图，二值图，边缘图
...
//		
//		//------9.15-------
//		static Point3d lastTrueResult = Point3d(999,999,0);
//		static Point3d lastResult = Point3d(999,999,0);
//		static Point3d lastLastResult = Point3d(999,999,0);
//
//		Point3d thisResult = Point3d(detectResult.y,detectResult.x,detectResult.z);//输出坐标赋值
//
//		if((thisResult.z == lastResult.z)||(thisResult.z == lastLastResult.z))
//		{
//			outputResult = thisResult;
//			lastTrueResult = thisResult;
//		}
//		else
//		{
//			outputResult = lastTrueResult;
//		}
//
//		cout<<"this:flag"<<thisResult.z<<"  x"<<thisResult.x<<"  y"<<thisResult.y;//#8.27
//		cout<<"  output:flag"<<outputResult.z<<"  x"<<outputResult.x<<"  y"<<outputResult.y<<endl;//#8.27
//		
