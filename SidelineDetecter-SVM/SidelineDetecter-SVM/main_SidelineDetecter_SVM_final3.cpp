...
#define TestVideo "../Data/TestVideo/out5.avi"	//用于检测的测试视频
#define ResultVideo "../Data/Result/out5.avi"		//测试视频的检测结果
...
int main()
{
	...
	while(!stop)
	{
		...
		////为了正常写视频，将单通道二值图像转三通道图像
		//vector<Mat>channels;
		//channels.push_back(tt);
		//channels.push_back(tt);
		//channels.push_back(tt);
		//Mat outputIm;
		//merge(channels,outputIm);
